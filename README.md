...
```bash
pip install "mexc-web @ git+https://github.com/artemdost/hedgersdev-mexc-web-sdk"
# с поддержкой WebSocket:
pip install "mexc-web[ws] @ git+https://github.com/artemdost/hedgersdev-mexc-web-sdk"
```
